...
void RubiksCube::print() const {
    ...
    for(int r=0;r<=2;r++) {
        for(int c=0;c<=2;c++) {
            cout<<getColorLetter(getColor(FACE::LEFT,r,c))<<" ";
        }
        cout<<" ";
        for(int c=0;c<=2;c++) {
            cout<<getColorLetter(getColor(FACE::FRONT,r,c))<<" ";
        }
        cout<<" ";
        for(int c=0;c<=2;c++) {
            cout<<getColorLetter(getColor(FACE::RIGHT,r,c))<<" ";
        }
        cout<<" ";
        for(int c=0;c<=2;c++) {
            cout<<getColorLetter(getColor(FACE::BACK,r,c))<<" ";
        }
        cout<<"\n";
    }
    for(int r=0;r<=2;r++) {
